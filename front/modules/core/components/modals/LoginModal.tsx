          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {import.meta.env.VITE_GOOGLE_CLIENT_ID ? (
              <div className="flex justify-center">
                {googleLoading
                  ? <div className="flex items-center gap-2 text-gray-500 text-sm py-1"><Loader2 className="w-4 h-4 animate-spin" /> A autenticar...</div>
              ...
              <button type="button" disabled className="w-full bg-gray-100 dark:bg-gray-800 text-gray-400 font-medium py-2.5 px-4 rounded-lg border border-gray-200 dark:border-gray-700 flex justify-center items-center gap-2 text-sm opacity-50 cursor-not-allowed">
