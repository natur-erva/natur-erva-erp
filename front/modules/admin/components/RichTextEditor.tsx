...
const Div = () => <div className="w-px h-5 bg-gray-200 dark:bg-gray-700 mx-0.5" />;
    ...
    <div className="border border-gray-300 dark:border-gray-700 rounded-xl overflow-hidden bg-white dark:bg-gray-900">
      ...
      <div className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
        ...
        <select
          ...
          className="text-xs px-1.5 py-1 rounded border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300"
          value={
        ...
        <span className="flex items-center gap-0.5">
          ...
          <input type="color" title="Cor personalizada"
            className="w-6 h-5 rounded border border-gray-300 cursor-pointer p-0"
