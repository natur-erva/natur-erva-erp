          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wide">Zona</th>
                <th className="px-4 py-3 text-right text-xs font-semibold text-gray-500 uppercase tracking-wide">Frete (MT)</th>
              ...
              {zones.map(z => (
                <tr key={z.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                  ...
                  <td className="px-4 py-3 text-right">
                    <span className={`font-semibold ${z.price === 0 ? 'text-green-600 dark:text-green-400' : 'text-gray-900 dark:text-white'}`}>
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
                <p className="text-xs text-gray-400 mt-1">Números menores aparecem primeiro no checkout</p>
              </div>
              ...
              <div className="flex items-center gap-3 pt-1">
                <button
                  ...
                  className={`flex items-center gap-2 text-sm font-medium transition-colors ${form.isActive ? 'text-green-600' : 'text-gray-400'}`}
                >
                  {form.isActive
